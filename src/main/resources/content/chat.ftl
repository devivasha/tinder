            ...
            <div class="chat-content">
                ...
                <div style="position: relative" class="col-md-12 p-2 msg-box border border-primary">
                    <div class="row">
                        ...
                        <form action="/message" method="post"  class="col-md-7 pl-0">
                            <input name="text" type="text" class="border-0" placeholder=" Send message" />
                            <input name="user" type="hidden" value="${counterpart.id}">
                            <button id="send" style="cursor: pointer; position: absolute; right: -77px; top: -3px; " type="submit">Send</button>
                        </form>
